...
%Defining lines 1
points1(1,:) =  linspace(0.007229,1.341,500);
points1(2,:) = linspace(1.151,1.341,500);

%Defining lines 2
points2(1,:) =  linspace(0,1.249,500);
points2(2,:) = linspace(-1.155,-1.837,500);

%Defining lines 3
points3(1,:) =  linspace(1.249,2.711,500);
points3(2,:) = linspace(-1.837,0.6961,500);
